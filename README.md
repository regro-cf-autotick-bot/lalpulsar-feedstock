...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/lalpulsar-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lalpulsar-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add lalpulsar lalpulsar-data liblalpulsar python-lalpulsar
# for installing globally
pixi global install lalpulsar lalpulsar-data liblalpulsar python-lalpulsar
```
...
It is possible to list all of the versions of `lalpulsar` available on your platform:
...
```
pixi search lalpulsar --channel conda-forge
```
